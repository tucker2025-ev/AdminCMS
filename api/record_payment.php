...
$stmt = $connect->prepare("SELECT paid_amount, remaining FROM service_list WHERE list_id = ? AND invoice_id = ?");
...
$update = $connect->prepare("UPDATE service_list SET paid_amount = ?, remaining = ?, last_updated_date = ? WHERE list_id = ? AND invoice_id = ?");
